...
def set_args():
    ...
    parser.add_argument('--train_data_path', default='./datasets/train/train.json', type=str, help='训练数据集')
    parser.add_argument('--test_data_path', default='./datasets/predict/test.json', type=str, help='测试数据集')
    parser.add_argument('--save_file', default='./datasets/evidences/SBERT_test.json', type=str,
                        help='save file path')
